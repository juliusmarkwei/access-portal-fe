			...
			<div className="container py-12 px-8 mt-[30px] flex flex-col h-[84dvh]">
				<main className="h-[60vh]">
					...
					<div className="flex flex-wrap">
						<form className="w-full md:w-1/2 flex flex-col justify-center items-center">
							<InputUI
							...
							<button
								className={`lg:mt-10 w-[150px] h-[55px] border-2 border-[#121b33] text-[#121b33] transition ease-in rounded-md hover:bg-[#121b33] hover:text-white ${
