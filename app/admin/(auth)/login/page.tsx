...
import AdminPageIllustrator from "@/public/12781040_5076089.svg";
    ...
    return (
        <main className="login-container">
            ...
            <div className="flex justify-center items-center flex-col w-[40%]">
                <Image
                    src={AdminPageIllustrator}
                    alt="Admin Page Illustrator"
                    className="w-[80%] h-[75%] p-4"
                />
            </div>
        </main>
    );
